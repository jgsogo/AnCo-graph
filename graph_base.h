...
namespace graph {
    ...
    class graph_base {
        ...
        public:
            ...
            virtual node_ptr get_node(const _t_node_id& node_id) = 0;
            virtual int get_edges(const _t_node_id& node_id, std::pair<std::vector<edge_ptr>, std::vector<edge_ptr>>& edges) = 0;
